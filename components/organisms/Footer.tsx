        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Where healing begins and hope is restored. We provide comprehensive wellness and rehabilitation services with compassion and expertise.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <span className="text-gray-300">(254) 722-520-122</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-4 h-4 mr-3 text-teal-400" />
                <span className="text-gray-300">eleoswellnesscentre@gmail.com</span>
              </li>
              <li className="flex items-start">
                <MapPin className="w-4 h-4 mr-3 mt-1 text-teal-400" />
